...
class TbExtendedTooltip extends CWidget
{
	...
	{
		$this->htmlOptions['title']=$this->getTooltip($this->key);
		$this->htmlOptions['name']=$this->key;
		$this->htmlOptions['rel']='editable-tooltip';
// 		'title' => $this->getTooltip($this->key), 'name' => $this->key
	...
	protected function getTooltip($key) {
		...
		$db=Utilities::getBaseDBConnection();
