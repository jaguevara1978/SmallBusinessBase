...
* http://jqueryui.com
* Includes: jquery.ui.core.js, jquery.ui.datepicker.js, jquery.ui.effect.js, jquery.ui.effect-fade.js
...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		dayNames: ['Domingo','Lunes','Martes','MiŽrcoles','Jueves','Viernes','S‡bado'], // For formatting
		dayNamesShort: ['Dom','Lun','Mar','MiŽ','Juv','Vie','S‡b'], // For formatting
		dayNamesMin: ['Do','Lu','Ma','Mi','Ju','Vi','S‡'], // Column headings for days starting at Sunday
		weekHeader: 'Sem', // Column header for week of the year
		dateFormat: 'yyyy-mm-dd', // See format options on parseDate
