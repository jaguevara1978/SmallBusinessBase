 ...
 class EmailWidget extends CWidget
{
    ...
    */
    ...
    private function showPrintLink() {
    	...
    	$imgUrl = $url.'/printer.png';
    	
    	$text = "&nbsp;".Yii::t('app', 'Send ');
    	$img = CHtml::image($imgUrl, Yii::t('app', 'Send '), array('title' => Yii::t('app', 'Send ')));
    
    	echo CHtml::link($img . $text, 
    			'',
    			array_merge($this->htmlOptions, 
    			array(
    ...
    public function init()
    {
    	...
    	$url = Yii::app()->getAssetManager()->publish($path);
		//         $imgUrl = $url.'/printer.png';
		//         echo CHtml::link("<img src=\"$imgUrl\" class=\"img_link\" title=\"".Yii::t('app', 'Print ')."\">", 
