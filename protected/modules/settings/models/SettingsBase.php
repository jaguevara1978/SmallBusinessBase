 ...
 */
class SettingsBase extends CActiveRecord {
	private static $dbBase = null;
	
	public function getDbConnection() {
		self::$dbBase=Utilities::getBaseDBConnection(self::$dbBase);
		return self::$dbBase;
	}
	...
	public function tableName() {
		...
		return $matches[1].'.settings_base';
	}
	...
	public static function getCount() {
		return SettingsBase::model()->count();
	}
