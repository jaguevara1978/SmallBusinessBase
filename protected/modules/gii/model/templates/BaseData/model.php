...
<?php foreach($rules as $rule): ?>
			<?php echo $rule.",\n"; ?>
<?php endforeach; ?>
			array('code','unique','attributeName'=>'code','className'=>'<?php echo $modelClass; ?>','allowEmpty'=>false),
			array('name','unique','attributeName'=>'name','className'=>'<?php echo $modelClass; ?>','allowEmpty'=>false),
...
?>
	...
	public static function getList(){
		...
		return CHtml::listData(<?php echo $modelClass; ?>::model()->findAll($criteria),'id','name');
	}
