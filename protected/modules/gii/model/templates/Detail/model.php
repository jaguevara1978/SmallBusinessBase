...
<?php endforeach; ?>
			'totalValue'=>Yii::t('app','model.<?php echo className($tableName);?>.totalValue'),
			'sumTotalValue'=>Yii::t('app','model.<?php echo className($tableName);?>.sumTotalValue'),
		);
	}
...
?>
	...
	public static function getCount($headerId=null) {
		...
		return <?php echo $modelClass; ?>::model()->count($condition,$parms);
	}
