<?php
/**
* RememberFilters class file.

* The RememberFilters extension adds up some functionality to the default
...
* add 'import' => 'RememberFilters', [...] to your
...
class RememberFilters extends CActiveRecordBehavior {
