...
class CButtonColumn extends CGridColumn
{
	...
	protected function initDefaultButtons()
	{
		...
		if($this->viewButtonImageUrl===null)
			$this->viewButtonImageUrl=Yii::app()->request->baseUrl.Yii::app()->params['General_BaseImageDirectory'].'Print.png';
		if($this->updateButtonImageUrl===null)
			$this->updateButtonImageUrl=Yii::app()->request->baseUrl.Yii::app()->params['General_BaseImageDirectory'].'Edit.png';
		if($this->deleteButtonImageUrl===null)
			$this->deleteButtonImageUrl=Yii::app()->request->baseUrl.Yii::app()->params['General_BaseImageDirectory'].'Erase24.png';
